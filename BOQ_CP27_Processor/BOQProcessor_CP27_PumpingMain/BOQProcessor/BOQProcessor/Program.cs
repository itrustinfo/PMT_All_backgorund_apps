...
namespace BOQProcessor
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string fileName = AppDomain.CurrentDomain.BaseDirectory + "\\1.CP 27-Billing breakup - Sewer & Pumping Main.xlsx";
            ...
            try
            {
                ...
                using (OleDbConnection con = new OleDbConnection(conn))
                {
                    try
                    {
                        ...
                        Console.WriteLine("Completed cP27 Sewer_&_Pumping Main ");
                        Console.ReadLine();
                    }
                    catch (Exception ex)
                    {
