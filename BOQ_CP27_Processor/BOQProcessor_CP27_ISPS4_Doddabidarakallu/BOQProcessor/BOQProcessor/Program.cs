...
namespace BOQProcessor
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string fileName = AppDomain.CurrentDomain.BaseDirectory + "\\BOQ_CP27_ISPS_Doddabidarakallu.xlsx";
            ...
            try
            {
                ...
                using (OleDbConnection con = new OleDbConnection(conn))
                {
                    try
                    {
                        ...
                        Console.WriteLine("Completed cP27 ISPS 4 Doddabidarakallu ");
                        Console.ReadLine();
                    }
                    catch (Exception ex)
                    {
