...
namespace BOQProcessor
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string fileName = AppDomain.CurrentDomain.BaseDirectory + "\\BOQ_CP27_KARIHOBANAHALLI.xlsx";
            ...
            try
            {
                ...
                using (OleDbConnection con = new OleDbConnection(conn))
                {
                    try
                    {
                        ...
                        Console.WriteLine("Completed CP27_KARIHOBANAHALLI");
                        Console.ReadLine();
                    }
                    catch (Exception ex)
                    {
