...
namespace BOQProcessor
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string fileName = AppDomain.CurrentDomain.BaseDirectory + "\\BOQ_CP25_DODDABETTAHALLI.xlsx";
            ...
            try
            {
                ...
                using (OleDbConnection con = new OleDbConnection(conn))
                {
                    try
                    {
                        ...
                        Console.WriteLine("Completed CP-25 DODDABETTAHALLI");
                        Console.ReadLine();
                    }
                    catch (Exception ex)
                    {
