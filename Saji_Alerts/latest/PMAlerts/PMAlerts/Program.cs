        ...
        public static  Boolean InsertBankGuaranteeIntoAlerts()
        {
            try
            {
                ...
                foreach (DataRow item in dt.Rows)
                {
                    ...
                    db_transact.InsertAlerts(new_id, new Guid(item.ItemArray[2].ToString()), alert_msg, DateTime.Today.Date, new Guid("419D71BD-FDD4-4A92-898C-A044BFA7803D"), new Guid(item.ItemArray[0].ToString()), new Guid(item.ItemArray[1].ToString()), "", Convert.ToDateTime(item.ItemArray[4].ToString()),"Bank Guarantee");
                }
        ...
        public static  Boolean InsertInsuranceIntoAlerts()
        {
            try
            {
                ...
                foreach (DataRow item in dt.Rows)
                {
                    ...
                    db_transact.InsertAlerts(new_id, new Guid(item.ItemArray[2].ToString()), alert_msg, DateTime.Today.Date, new Guid("419D71BD-FDD4-4A92-898C-A044BFA7803D"), new Guid(item.ItemArray[3].ToString()), new Guid(item.ItemArray[4].ToString()), "", Convert.ToDateTime(item.ItemArray[5].ToString()),"Insurance Policy");
                }
        ...
        public static  Boolean InsertIssueIntoAlerts()
        {
            try
            {
                ...
                foreach (DataRow item in dt.Rows)
                {
                    ...
                    db_transact.InsertAlerts(new_id, new Guid(item.ItemArray[1].ToString()), alert_msg, DateTime.Today.Date, new Guid("419D71BD-FDD4-4A92-898C-A044BFA7803D"), new Guid(item.ItemArray[2].ToString()), new Guid(item.ItemArray[3].ToString()), "", Convert.ToDateTime(item.ItemArray[5].ToString()),"Issue");
                }
