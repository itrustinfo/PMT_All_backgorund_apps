...
<asp:Content ID="Content1" ContentPlaceHolderID="modal_master_head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function PrintDiv(id) {
            ...
            var myWindow = window.open('', 'prt div', 'height=600,width=800');
...
<asp:Content ID="Content2" ContentPlaceHolderID="modal_master_body" runat="server">
    ...
    <div class="container-fluid" style="overflow-y:auto; min-height:83vh;">
        ...
        <div class="row">
           <div class="col-sm-12">
               ...
               <div class="form-group">
                       <div class="form-group" >
                        <label class="lblCss" for="lblUser">Issue User</label>&nbsp;&nbsp;<b>:</b>&nbsp;&nbsp;
            ...
            <div class="col-sm-12">
                <div class="table-responsive">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="doc_name" HeaderText="Doc names" HtmlEncode="false">
                            <HeaderStyle HorizontalAlign="Left" />
                            </asp:BoundField>
    ...
    <div class="modal-footer">
        <div style="padding:10px">
            ...
            <%--<a id="doc_pre" runat="server" href="/_modal_pages/preview-issue-docs.aspx" class="showDocModal"><asp:Button ID="Button2" runat="server" Text="View All Documents" CssClass="btn btn-primary"></asp:Button></a>--%>
        </div>
    </div>
        ...
        <div class="row">
           <div class="col-sm-12">
                <div class="form-group">
                       <div class="form-group" >
                        <label class="lblCss" for="lblWorkPackage">Issue</label>&nbsp;&nbsp;<b>:</b>&nbsp;&nbsp;
                         <asp:Label ID="Label1" class="lblCss" Font-Bold="true" runat="server"></asp:Label>
                    </div>
                 </div>
               <div class="form-group">
                       <div class="form-group" >
