...
namespace ProjectManagementTool._modal_pages
{
    public partial class View_IssueHistory : System.Web.UI.Page
    {
        ...
        private void IssueHistoryBind()
        {
            ...
            {
                LblIssue.Text = GrdIssueStatus.Rows[0].Cells[0].Text;
                LblUser.Text = getdata.getUserNameby_UID(new Guid(GrdIssueStatus.Rows[0].Cells[1].Text));

                Label1.Text = GrdIssueStatus.Rows[0].Cells[0].Text;
                Label2.Text = getdata.getUserNameby_UID(new Guid(GrdIssueStatus.Rows[0].Cells[1].Text));
            }
