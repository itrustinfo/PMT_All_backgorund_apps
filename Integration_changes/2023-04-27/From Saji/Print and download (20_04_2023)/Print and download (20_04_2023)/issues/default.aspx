...
<ItemStyle Width="20%"></ItemStyle>
                                                ...
                                                <HeaderStyle HorizontalAlign="Left" />
                                                    ...
                                                    <ItemStyle CssClass="hiddencol"></ItemStyle>
                                                        ...
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                <a id="printDocs" target="_blank"  href="/_content_pages/doctobrowser/default.aspx?Issue_Uid=<%#Eval("Issue_Uid")%>&PrjID=<%#Eval("ProjectUID")%>"  ><span title="print" class="fas fa-print"></span></a>
