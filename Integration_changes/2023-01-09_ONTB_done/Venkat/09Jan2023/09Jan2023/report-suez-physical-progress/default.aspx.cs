        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string HTMLstring = "<html><body>" +
                    ...
                    "<asp:Label ID='Lbl1' runat='server' Font-Bold='true'>" + WebConfigurationManager.AppSettings["Domain"] + " Report Name: Physical Progress Report-Custom Report</asp:Label><br />" +
                ...
                string strFile = "Report_Progrees_report_" + DateTime.Now.Ticks + ".xls";
