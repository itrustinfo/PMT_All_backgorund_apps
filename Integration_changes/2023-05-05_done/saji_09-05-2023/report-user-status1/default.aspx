                            ...
                            <div class="card-title">
                                <div class="d-flex justify-content-between">
                                   <%-- <h6 class="text-muted">
                                    ...
                                    <div class="col-3">
                                    <asp:DropDownList ID="DDlUser" runat="server" CssClass="form-control" AutoPostBack="false" OnSelectedIndexChanged="DDlUser_SelectedIndexChanged"></asp:DropDownList>
                                    </div>
                                    ...
                                    <div>
                                        <asp:Button ID="btnRefresh" runat="server" Text="Submit" CssClass="btn btn-primary" Visible="true" OnClick="btnRefresh_Click"></asp:Button>&nbsp;
                                        ...
                                        <asp:GridView ID="grdDataList" runat="server" AutoGenerateColumns="false" CellPadding="6" CellSpacing="16"  HeaderStyle-BackColor="#666666" HeaderStyle-ForeColor="White" 
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField  HeaderText="Approved so far" >
                                                    <ItemTemplate>
                                                        <a class="showModalDocumentView" href="/_content_pages/report-mis-user-details?ProjectName=<%#Eval("ProjectName")%>&FlowName=<%#Eval("DocumentType")%>&type=ApprovedSofar&user_id="><%#Eval("ApprovedSofar")%></a>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                 <asp:BoundField DataField="PendingAsOnDate"  HeaderText="Pending as on date" >
                                                    <HeaderStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
