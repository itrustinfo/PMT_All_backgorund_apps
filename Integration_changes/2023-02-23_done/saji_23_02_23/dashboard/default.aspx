                    ...
                    <div class="card h-100">
                        <div class="card-body" style="font-weight:900">
                            ...
                            <table style="width:100%;line-height:30px">
                                ...
                                <tr id="trSuezblock" runat="server"><td colspan="3"><hr style="width:100%;background-color:black;border-width:3px"></td></tr>
                    ...
                    <div class="card h-100">
                         <div class="card-body">
                            <%--<h6 class="card-title text-muted text-uppercase font-weight-bold">Resource</h6>--%>
                             <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">Concrete</span>
                                </div>
                                
                              
                            </div>
                           <asp:Literal ID="ltScript_Concrete" runat="server"></asp:Literal>
                            <div id="Concrete_div" style="width:100%; height:275px; margin-top:10px;"></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card h-100">
                         <div class="card-body">
                            <%--<h6 class="card-title text-muted text-uppercase font-weight-bold">Resource</h6>--%>
                             <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">Labour</span>
                                </div>
                                
                              
                            </div>
                           <asp:Literal ID="ltScript_Labour" runat="server"></asp:Literal>
                            <div id="labour_div" style="width:100%; height:275px; margin-top:10px;"></div>
                        </div>
                    </div>
                </div>
